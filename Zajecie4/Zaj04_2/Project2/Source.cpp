...
void GenerateTextures()
{
	...
	error = load_targa("multiple_trees_20150403_1132855568.tga", width, height, format, type, pixels);

	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku multiple_trees_20150403_1132855568tga");
		exit(0);
	}
