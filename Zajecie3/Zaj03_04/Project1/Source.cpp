...
void GenerateDisplayLists()
{
	...
	//4 okna
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-0.90, 0.1, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(-0.10, 0.10, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(-0.10, 0.90, 1.01);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-0.90, 0.1, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(-0.10, 0.90, 1.01);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(-0.90, 0.90, 1.01);
	...
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.01, 0.1, 0.90);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1.01, 0.10, 0.1);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.01, 0.90, 0.1);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.01, 0.1, 0.9);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.01, 0.90, 0.1);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1.01, 0.90, 0.9);
