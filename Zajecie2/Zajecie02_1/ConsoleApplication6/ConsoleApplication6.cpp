...
//Stworzyæ w œrodowisku trójwymiarowym korkoci¹g wokó³ osi{ x | y | z }
//zawieraj¹cy N obrotów.Punkty s¹ stopniowo powiêkszane od najmniejszej 
//mo¿liwej wartoœci, do najwiêkszej.W funkcji SetupRC ustaliæ aktualny kolor rysuj¹cy na{ zielony | niebieski | br¹zowy | … }.
//oœ y
//5 obrotow 
...

{
	...
	GLfloat x = 0, y, z = 0, angle; // Zmienne przechowuj¹ce wspó³rzêdne i k¹ty
	...
	for (angle = 0.0f; angle <= (2.0f*3.1415f)*5.0f; angle += 0.1f)
